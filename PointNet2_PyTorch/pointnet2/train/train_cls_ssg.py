...
from pointnet2.models.pointnet2_ssg_cls import model_fn_decorator
...
if __name__ == "__main__":
    ...
    trainer = pt_utils.Trainer(
        ...
        model_fn,
        optimizer,
        checkpoint_name="checkpoints_ssg/pointnet2_cls",
        best_name="checkpoints_ssg/pointnet2_cls_best",
