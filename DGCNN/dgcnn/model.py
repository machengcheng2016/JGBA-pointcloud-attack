...
def get_graph_feature(x, k=20, idx=None):
    ...
    feature = torch.cat((feature-x, x), dim=3).permute(0, 3, 1, 2)      # feature are picked by idx (computed same with my KNN), feature-x are edges between x and KNN nodes.
...
class DGCNN(nn.Module):
    def __init__(self, k, emb_dims=1024, dropout=0.5, output_channels=40):
